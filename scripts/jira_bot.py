...
def get_template_comment():
    ...
    comment += '{panel:title=If recurring, how frequent can it be?} \n Edit this line to say one of the following - Every Day, Every Week, Bi-weekly, Every month, Once in a few months, Once in 5-6 months, Once in a year.{panel}\n\n\n'
    comment += "----"
